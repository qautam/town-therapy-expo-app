...
/** Town Therapy civic movement photos for the home banner. */
export const UPDATE_MOVEMENT_PHOTOS: ImageSourcePropType[] = [
  require('@/assets/updates/street-flags.jpg'),
  require('@/assets/updates/street-cafe.jpg'),
